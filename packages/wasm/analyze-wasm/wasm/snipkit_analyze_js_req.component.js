function instantiate(getCoreModule, imports, instantiateCore = WebAssembly.instantiate) {
  ...
  const module0 = getCoreModule('snipkit_analyze_js_req.component.core.wasm');
  const module1 = getCoreModule('snipkit_analyze_js_req.component.core2.wasm');
  const module2 = getCoreModule('snipkit_analyze_js_req.component.core3.wasm');
