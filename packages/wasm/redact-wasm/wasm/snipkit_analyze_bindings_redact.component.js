function instantiate(getCoreModule, imports, instantiateCore = WebAssembly.instantiate) {
  ...
  const module0 = getCoreModule('snipkit_analyze_bindings_redact.component.core.wasm');
  const module1 = getCoreModule('snipkit_analyze_bindings_redact.component.core2.wasm');
  const module2 = getCoreModule('snipkit_analyze_bindings_redact.component.core3.wasm');
