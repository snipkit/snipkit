...
export declare enum BotType {
   ...
   * list of verified good bots. This is manually maintained by the Snipkit
...
/**
 * The conclusion for the request based on the Snipkit analysis and any specific
 * configuration.
 *
...
/**
 * Additional information from Snipkit about the IP address associated with a
 * request.
 *
 ...
 * and by logging into the Snipkit dashboard and searching for the decision ID.
 *
...
export declare class Reason extends Message<Reason> {
  ...
  reason: {
    ...
    /**
     * Contains details about why Snipkit Shield was triggered.
     *
...
export declare class RateLimitRule extends Message<RateLimitRule> {
  ...
  /**
   * The request path the rate limit applies to. If not specified and Snipkit
   * is running on a specific API route, it defaults to the path for that
   * route. If not specified and Snipkit is running from middleware, it applies
   * to all routes.
   *
  ...
  /**
   * Defines how Snipkit will track rate limits. If none are specified, it will
   ...
   * https://docs-snipkit.khulnasoft.com/architecture/#fingerprinting
   *
...
export declare class BotRule extends Message<BotRule> {
  ...
  /**
   * Additional bot detection rules to add or remove from the Snipkit standard
...
export declare class ShieldRule extends Message<ShieldRule> {
  ...
  /**
   * Defines how Snipkit will track suspicious requests. If none are specified,
   ...
   * see https://docs-snipkit.khulnasoft.com/architecture/#fingerprinting
   *
   * @generated from field: repeated string characteristics = 3;
   */
  characteristics: string[];
...
export declare class Decision extends Message<Decision> {
   ...
   * be used to search for the request details in the Snipkit dashboard.
   *
  ...
  /**
   * Snipkit's conclusion for the request based on our analysis.
   *
...
export declare class DecideResponse extends Message<DecideResponse> {
  ...
  /**
   * Any extra information returned by the Snipkit analysis.
   *
