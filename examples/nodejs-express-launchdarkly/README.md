...
# Snipkit Dynamic Configuration via LaunchDarkly Feature Flags

This example shows how to dynamically configure Snipkit via
...
3. Rename `.env.local.example` to `.env.local` and add your [Snipkit key](https://app-snipkit.khulnasoft.com)
