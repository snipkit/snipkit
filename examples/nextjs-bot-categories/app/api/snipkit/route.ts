import snipkit, { botCategories, detectBot } from "@snipkit/next";
...
export async function GET(req: Request) {
  ...
  if (decision.reason.isBot()) {
    ...
    headers.set("X-Snipkit-Bot-Allowed", decision.reason.allowed.join(", "))
    headers.set("X-Snipkit-Bot-Denied", decision.reason.denied.join(", "))
