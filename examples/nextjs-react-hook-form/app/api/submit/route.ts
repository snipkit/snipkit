...
import snipkit, { protectSignup } from "@snipkit/next";
...
const aj = snipkit({
  ...
  rules: [
    // Snipkit's protectSignup rule is a combination of email validation, bot
    ...
    // https://docs-snipkit.khulnasoft.com/get-started
    protectSignup({
      email: {
