    ...
    <section className="container grid items-center gap-6 pb-8 pt-6 md:py-10">
      <div className="flex max-w-[980px] flex-col items-start gap-2">
        ...
        <p className="max-w-[700px]">
          This form uses{" "}
          <Link href="https://docs-snipkit.khulnasoft.com/signup-protection/quick-start/nextjs" className="underline">
            Snipkit&apos;s signup form protection
          </Link>{" "}
          which includes:
        </p>
        <ul className="ms-8 max-w-[700px] list-outside list-disc">
          <li>
            Server-side email verification with Snipkit to check if the email is
      ...
      <div className="flex gap-4">
        <Link
          href="https://docs-snipkit.khulnasoft.com"
          target="_blank"
          rel="noreferrer"
        ...
        <Link
          href="https://app-snipkit.khulnasoft.com"
          target="_blank"
          rel="noreferrer"
          className={buttonVariants({ variant: "outline" })}
        >
