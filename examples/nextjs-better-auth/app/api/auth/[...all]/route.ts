...
const aj = snipkit({
  ...
  rules: [
    // Protect against common attacks with Snipkit Shield. Other rules are
...
async function protect(req: NextRequest): Promise<SnipkitDecision> {
  ...
  // See https://docs-snipkit.khulnasoft.com/signup-protection/quick-start
...
// Wrap the POST handler with Snipkit protections
